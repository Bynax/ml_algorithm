...
class LinearRegression:
    ...
    def fit_gd(self, X_train, y_train, learning_rate=0.01, n_iters=100):
        """
        ...
        def gradient_descent(X_b, y, initial_theta, learning_rate, n_iters=1e4, epsilon=1):
            """
...
if __name__ == '__main__':
    ...
    regression.fit_gd(X_train, y_train)
