# -*- coding: utf-8 -*-
# Created by bohuanshi on 2019-08-16
import numpy as np
...
def generate_X(true_Mu, true_Var):
    """
    生成数据
    :param true_Mu: 真实高斯分布均值
    :param true_Var: 真实高斯分布方差
    :return:
    """
    # 第一簇的数据
...
if __name__ == '__main__':
    # 生成数据
    true_Mu = [[0.5, 0.5], [5.5, 2.5], [1, 7]]  # 真实均值
    true_Var = [[1, 3], [2, 2], [6, 2]]  # 真实方差
    X = generate_X(true_Mu, true_Var)
    # 初始化
    n_clusters = 3  # GMM中分布的cluster同K-Means一样是超参数，需要指定
    n_points = len(X)
    Mu = [[0, -1], [6, 0], [0, 9]]  # 初始化均值
    Var = [[1, 1], [1, 1], [1, 1]]  # 初始化方差
    Pi = [1 / n_clusters] * 3
